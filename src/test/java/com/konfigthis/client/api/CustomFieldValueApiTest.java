...
/**
 * API tests for CustomFieldValueApi
 */
@Disabled
public class CustomFieldValueApiTest {

    private static CustomFieldValueApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CustomFieldValueApi(apiClient);
    }
     ...
     */
    @Test
    public void createCustomValueTest() throws ApiException {
        String value = null;
        Integer fieldId = null;
        Integer instanceId = null;
        CustomValue response = api.createCustomValue(value, fieldId, instanceId)
                .execute();
     ...
     */
    @Test
    public void getBySlugNameTest() throws ApiException {
        Integer id = null;
        Integer slugId = null;
        Integer fieldId = null;
        ...
        List<CustomValueV2> response = api.getBySlugName()
                .id(id)
                .slugId(slugId)
                .fieldId(fieldId)
                .slugName(slugName)
     ...
     */
    @Test
    public void getInstanceValueTest() throws ApiException {
        Integer fieldId = null;
        Integer instanceId = null;
        CustomValue response = api.getInstanceValue(fieldId, instanceId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateValueTest() throws ApiException {
        Integer id = null;
        String value = null;
        CustomFieldV2 response = api.updateValue(id)
                .value(value)
                .execute();
        // TODO: test validations
    }
