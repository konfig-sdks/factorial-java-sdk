...
public class FolderApiTest {
    ...
    private static FolderApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new FolderApi(apiClient);
    }
    ...
    public void createNewFolderTest() throws ApiException {
        String name = null;
        Boolean active = null;
        List<Folder> response = api.createNewFolder(name)
                .active(active)
                .execute();
    ...
    public void getByIdTest() throws ApiException {
        String id = null;
        Folder response = api.getById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getByNameAndStatusTest() throws ApiException {
        String name = null;
        Boolean active = null;
        List<Folder> response = api.getByNameAndStatus()
                .name(name)
                .active(active)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void updateFolderByIdTest() throws ApiException {
        String id = null;
        String name = null;
        Boolean active = null;
        Folder response = api.updateFolderById(id)
                .name(name)
                .active(active)
                .execute();
        // TODO: test validations
