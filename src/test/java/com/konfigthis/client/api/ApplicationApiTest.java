...
public class ApplicationApiTest {
     ...
     */
    @Test
    public void createAtsApplicationTest() throws ApiException {
        Integer atsJobPostingId = null;
        String source = null;
        String medium = null;
        Integer atsCandidateId = null;
        ...
        File cv = null;
        File photo = null;
        List<ApplicationCreateAtsApplicationRequestAnswersInner> answers = null;
        AtsApplication response = api.createAtsApplication(atsJobPostingId, source)
                .medium(medium)
    ...
    public void updateDataTest() throws ApiException {
        String id = null;
        Integer atsApplicationPhaseId = null;
        ...
        File cv = null;
        File photo = null;
        AtsApplication response = api.updateData(id)
