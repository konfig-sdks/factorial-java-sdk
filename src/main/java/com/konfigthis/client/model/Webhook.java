...
public class Webhook {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "employee_created", value = "")
  ...
  public Webhook targetUrl(String targetUrl) {
  ...
  **/
  ...
  public Webhook companyId(Integer companyId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhook.id) &&
        ...
        Objects.equals(this.targetUrl, webhook.targetUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, targetUrl, companyId, additionalProperties);
  }
