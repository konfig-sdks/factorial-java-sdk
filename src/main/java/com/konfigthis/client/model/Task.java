...
public class Task {
  ...
  **/
  ...
  public Task dueOn(String dueOn) {
  ...
  **/
  ...
  public Task assigneeIds(List<Integer> assigneeIds) {
  ...
  public Task addAssigneeIdsItem(Integer assigneeIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-12-13T16:17:56.000Z", value = "")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, task.id) &&
        ...
        Objects.equals(this.assigneeIds, task.assigneeIds) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, content, dueOn, assigneeIds, completedAt, additionalProperties);
  }
