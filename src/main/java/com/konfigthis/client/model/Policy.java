...
public class Policy {
  ...
  public static final String SERIALIZED_NAME_DEFAULT_ALLOWANCE_ID = "default_allowance_id";
  @SerializedName(SERIALIZED_NAME_DEFAULT_ALLOWANCE_ID)
  private Integer defaultAllowanceId;

  public static final String SERIALIZED_NAME_ALLOWANCE_INCIDENCES = "allowance_incidences";
  @SerializedName(SERIALIZED_NAME_ALLOWANCE_INCIDENCES)
  private Integer allowanceIncidences;
  ...
  **/
  ...
  public Policy main(Boolean main) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Holiday Policy", value = "")
  ...
  public Policy defaultAllowanceId(Integer defaultAllowanceId) {
    
    
    
    
    this.defaultAllowanceId = defaultAllowanceId;
    return this;
  }

   /**
   * Get defaultAllowanceId
   * @return defaultAllowanceId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3", value = "")

  public Integer getDefaultAllowanceId() {
    return defaultAllowanceId;
  }


  public void setDefaultAllowanceId(Integer defaultAllowanceId) {
  ...
  public Policy allowanceIncidences(Integer allowanceIncidences) {
    
    
    
    
    this.allowanceIncidences = allowanceIncidences;
    return this;
  }

   /**
   * Get allowanceIncidences
   * @return allowanceIncidences
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0", value = "")

  public Integer getAllowanceIncidences() {
    return allowanceIncidences;
  }


  public void setAllowanceIncidences(Integer allowanceIncidences) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, policy.description) &&
        ...
        Objects.equals(this.main, policy.main) &&
        Objects.equals(this.name, policy.name) &&
        Objects.equals(this.defaultAllowanceId, policy.defaultAllowanceId) &&
        Objects.equals(this.allowanceIncidences, policy.allowanceIncidences)&&
        Objects.equals(this.additionalProperties, policy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, main, name, defaultAllowanceId, allowanceIncidences, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    defaultAllowanceId: ").append(toIndentedString(defaultAllowanceId)).append("\n");
    sb.append("    allowanceIncidences: ").append(toIndentedString(allowanceIncidences)).append("\n");
  ...
  static {
    ...
    openapiFields.add("default_allowance_id");
    openapiFields.add("allowance_incidences");
