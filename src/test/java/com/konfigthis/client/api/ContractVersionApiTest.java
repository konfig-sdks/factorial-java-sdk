...
/**
 * API tests for ContractVersionApi
 */
@Disabled
public class ContractVersionApiTest {

    private static ContractVersionApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ContractVersionApi(apiClient);
    }
    ...
    public void createNewVersionTest() throws ApiException {
        ...
        String endsOn = null;
        String workingHoursFrequency = null;
        String workingWeekDays = null;
        Integer workingHours = null;
        String salaryFrequency = null;
        Integer salaryAmount = null;
        String jobTitle = null;
        ContractVersion response = api.createNewVersion()
     ...
     */
    @Test
    public void getAllVersionsTest() throws ApiException {
        List<ContractVersion> response = api.getAllVersions()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getBulkVersionsTest() throws ApiException {
        List<ContractVersion> response = api.getBulkVersions()
                .execute();
        // TODO: test validations
    }
