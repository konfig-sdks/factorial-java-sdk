...
public class LeaveWebhook {
 ...
 public enum HalfDayEnum {
  ...
  public LeaveWebhook id(Integer id) {
  ...
  **/
  ...
  public LeaveWebhook approved(Boolean approved) {
  ...
  **/
  ...
  public LeaveWebhook employeeId(Integer employeeId) {
  ...
  **/
  ...
  public LeaveWebhook startOn(String startOn) {
  ...
  **/
  ...
  public LeaveWebhook finishOn(String finishOn) {
  ...
  **/
  ...
  public LeaveWebhook halfDay(HalfDayEnum halfDay) {
  ...
  **/
  ...
  public LeaveWebhook leaveTypeId(Integer leaveTypeId) {
  ...
  **/
   ...
   * @return the LeaveWebhook instance itself
   */
  public LeaveWebhook putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveWebhook leaveWebhook = (LeaveWebhook) o;
    return Objects.equals(this.id, leaveWebhook.id) &&
        Objects.equals(this.approved, leaveWebhook.approved) &&
        Objects.equals(this.employeeId, leaveWebhook.employeeId) &&
        Objects.equals(this.startOn, leaveWebhook.startOn) &&
        Objects.equals(this.finishOn, leaveWebhook.finishOn) &&
        Objects.equals(this.halfDay, leaveWebhook.halfDay) &&
        Objects.equals(this.leaveTypeId, leaveWebhook.leaveTypeId)&&
        Objects.equals(this.additionalProperties, leaveWebhook.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, approved, employeeId, startOn, finishOn, halfDay, leaveTypeId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LeaveWebhook {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveWebhook
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveWebhook is not found in the empty JSON string", LeaveWebhook.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveWebhook>() {
           @Override
           public void write(JsonWriter out, LeaveWebhook value) throws IOException {
           ...
           @Override
           public LeaveWebhook read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveWebhook instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveWebhook given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveWebhook
  * @throws IOException if the JSON string is invalid with respect to LeaveWebhook
  */
  public static LeaveWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveWebhook.class);
  }

 /**
  * Convert an instance of LeaveWebhook to an JSON string
  *
  * @return JSON string
  */
