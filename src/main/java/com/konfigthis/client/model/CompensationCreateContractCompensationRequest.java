...
public class CompensationCreateContractCompensationRequest {
  public static final String SERIALIZED_NAME_DESCRIPTION = "description";
  @SerializedName(SERIALIZED_NAME_DESCRIPTION)
  private String description;

  public static final String SERIALIZED_NAME_CONTRACT_VERSION_ID = "contract_version_id";
  @SerializedName(SERIALIZED_NAME_CONTRACT_VERSION_ID)
 ...
 public enum CalculationEnum {
  ...
  public CompensationCreateContractCompensationRequest() {
  }

  public CompensationCreateContractCompensationRequest description(String description) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest contractVersionId(Integer contractVersionId) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest contractsTaxonomyId(Integer contractsTaxonomyId) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest compensationType(CompensationTypeEnum compensationType) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest amount(Integer amount) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest unit(UnitEnum unit) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest syncWithSupplements(Boolean syncWithSupplements) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest payrollPolicyId(Integer payrollPolicyId) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest recurrenceCount(Integer recurrenceCount) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest startsOn(String startsOn) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest recurrence(RecurrenceEnum recurrence) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest firstPaymentOn(String firstPaymentOn) {
  ...
  **/
  ...
  public CompensationCreateContractCompensationRequest calculation(CalculationEnum calculation) {
  ...
  **/
   ...
   * @return the CompensationCreateContractCompensationRequest instance itself
   */
  public CompensationCreateContractCompensationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompensationCreateContractCompensationRequest compensationCreateContractCompensationRequest = (CompensationCreateContractCompensationRequest) o;
    return Objects.equals(this.description, compensationCreateContractCompensationRequest.description) &&
        Objects.equals(this.contractVersionId, compensationCreateContractCompensationRequest.contractVersionId) &&
        Objects.equals(this.contractsTaxonomyId, compensationCreateContractCompensationRequest.contractsTaxonomyId) &&
        Objects.equals(this.compensationType, compensationCreateContractCompensationRequest.compensationType) &&
        Objects.equals(this.amount, compensationCreateContractCompensationRequest.amount) &&
        Objects.equals(this.unit, compensationCreateContractCompensationRequest.unit) &&
        Objects.equals(this.syncWithSupplements, compensationCreateContractCompensationRequest.syncWithSupplements) &&
        Objects.equals(this.payrollPolicyId, compensationCreateContractCompensationRequest.payrollPolicyId) &&
        Objects.equals(this.recurrenceCount, compensationCreateContractCompensationRequest.recurrenceCount) &&
        Objects.equals(this.startsOn, compensationCreateContractCompensationRequest.startsOn) &&
        Objects.equals(this.recurrence, compensationCreateContractCompensationRequest.recurrence) &&
        Objects.equals(this.firstPaymentOn, compensationCreateContractCompensationRequest.firstPaymentOn) &&
        Objects.equals(this.calculation, compensationCreateContractCompensationRequest.calculation)&&
        Objects.equals(this.additionalProperties, compensationCreateContractCompensationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, contractVersionId, contractsTaxonomyId, compensationType, amount, unit, syncWithSupplements, payrollPolicyId, recurrenceCount, startsOn, recurrence, firstPaymentOn, calculation, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompensationCreateContractCompensationRequest {\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    contractVersionId: ").append(toIndentedString(contractVersionId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("contract_version_id");
    ...
    openapiRequiredFields.add("contract_version_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompensationCreateContractCompensationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompensationCreateContractCompensationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompensationCreateContractCompensationRequest is not found in the empty JSON string", CompensationCreateContractCompensationRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompensationCreateContractCompensationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompensationCreateContractCompensationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompensationCreateContractCompensationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompensationCreateContractCompensationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompensationCreateContractCompensationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CompensationCreateContractCompensationRequest>() {
           @Override
           public void write(JsonWriter out, CompensationCreateContractCompensationRequest value) throws IOException {
           ...
           @Override
           public CompensationCreateContractCompensationRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompensationCreateContractCompensationRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompensationCreateContractCompensationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompensationCreateContractCompensationRequest
  * @throws IOException if the JSON string is invalid with respect to CompensationCreateContractCompensationRequest
  */
  public static CompensationCreateContractCompensationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompensationCreateContractCompensationRequest.class);
  }

 /**
  * Convert an instance of CompensationCreateContractCompensationRequest to an JSON string
  *
  * @return JSON string
  */
