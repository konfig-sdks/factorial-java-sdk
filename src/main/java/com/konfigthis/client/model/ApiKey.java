...
public class ApiKey {
  ...
  public static final String SERIALIZED_NAME_TOKEN_DIGEST = "token_digest";
  @SerializedName(SERIALIZED_NAME_TOKEN_DIGEST)
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Company Api Key", value = "")
  ...
  public ApiKey tokenDigest(String tokenDigest) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "069cf78dd2a3********************67c1fcfb38bdb1e1bf5c3a1e451499848f", value = "")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, apiKey.id) &&
        ...
        Objects.equals(this.tokenDigest, apiKey.tokenDigest) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, tokenDigest, createdAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("token_digest");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("token_digest") != null && !jsonObj.get("token_digest").isJsonNull()) && !jsonObj.get("token_digest").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `token_digest` to be a primitive type in the JSON string but got `%s`", jsonObj.get("token_digest").toString()));
      }
