...
public class AttendanceApiTest {
    ...
    public void createNewTest() throws ApiException {
        ...
        Attendance response = api.createNew(employeeId, clockIn, clockOut)
    ...
    public void getBulkV2Test() throws ApiException {
        List<Attendance> response = api.getBulkV2()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getCompanyAttendanceTest() throws ApiException {
        List<Integer> employeeIds = null;
        String dateFrom = null;
        String dateTo = null;
        List<Attendance> response = api.getCompanyAttendance()
