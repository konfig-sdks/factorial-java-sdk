...
public class TaskApiTest {
     ...
     */
    @Test
    public void addFileToTaskTest() throws ApiException {
        String id = null;
        File _file = null;
        Task response = api.addFileToTask(id)
                ._file(_file)
                .execute();
     ...
     */
    @Test
    public void copyByIdTest() throws ApiException {
        String id = null;
        String name = null;
        Task response = api.copyById(id)
                .name(name)
                .execute();
        // TODO: test validations
    }
    ...
    public void createNewTaskTest() throws ApiException {
        ...
        Task response = api.createNewTask(name)
                .dueOn(dueOn)
                .content(content)
    ...
    public void deleteByIdTest() throws ApiException {
        String id = null;
        Task response = api.deleteById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteFileInTaskTest() throws ApiException {
        String taskId = null;
        String id = null;
        TaskFile response = api.deleteFileInTask(taskId, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllTasksTest() throws ApiException {
        ...
        List<Task> response = api.getAllTasks()
    ...
    public void getFileTest() throws ApiException {
        String taskId = null;
        String id = null;
        TaskFile response = api.getFile(taskId, id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getFilesTest() throws ApiException {
        String id = null;
        TaskFile response = api.getFiles(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void resolveByIdTest() throws ApiException {
        String id = null;
        Boolean done = null;
        Task response = api.resolveById(id)
                .done(done)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateByIdTest() throws ApiException {
        ...
        String content = null;
        List<Integer> assigneeIds = null;
        Task response = api.updateById(id)
                .dueOn(dueOn)
                .name(name)
                .content(content)
                .assigneeIds(assigneeIds)
