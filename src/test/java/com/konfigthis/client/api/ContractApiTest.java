...
public class ContractApiTest {
    ...
    public void deleteVersionTest() throws ApiException {
        String id = null;
        ContractVersion response = api.deleteVersion(id)
                .execute();
     ...
     */
    @Test
    public void getAllReferenceContractsTest() throws ApiException {
        List<Integer> employeeIds = null;
        List<ContractVersion> response = api.getAllReferenceContracts()
    ...
    public void updateVersionTest() throws ApiException {
        ...
        Integer esCotizationGroup = null;
        Integer esProfessionalCategoryId = null;
        Integer esEducationLevelId = null;
        Integer esContractTypeId = null;
        ContractVersion response = api.updateVersion(effectiveOn, id)
