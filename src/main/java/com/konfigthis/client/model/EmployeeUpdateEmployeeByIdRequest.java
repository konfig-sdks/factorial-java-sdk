...
public class EmployeeUpdateEmployeeByIdRequest {
 ...
 public enum IdentifierTypeEnum {
  ...
  public EmployeeUpdateEmployeeByIdRequest() {
  }

  public EmployeeUpdateEmployeeByIdRequest email(String email) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest firstName(String firstName) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest lastName(String lastName) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest birthdayOn(String birthdayOn) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest role(RoleEnum role) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest gender(GenderEnum gender) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest identifier(String identifier) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest identifierType(IdentifierTypeEnum identifierType) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest nationality(String nationality) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest bankNumber(String bankNumber) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest country(String country) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest city(String city) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest state(String state) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest postalCode(String postalCode) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest addressLine1(String addressLine1) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest addressLine2(String addressLine2) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest swiftBic(String swiftBic) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest managerId(Integer managerId) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest locationId(Integer locationId) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest timeoffManagerId(Integer timeoffManagerId) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest phoneNumber(String phoneNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "678901234", value = "")
  ...
  public EmployeeUpdateEmployeeByIdRequest socialSecurityNumber(Integer socialSecurityNumber) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest legalEntityId(Integer legalEntityId) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest companyIdentifier(String companyIdentifier) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest contactName(String contactName) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest contactNumber(String contactNumber) {
  ...
  **/
  ...
  public EmployeeUpdateEmployeeByIdRequest taxId(String taxId) {
  ...
  **/
   ...
   * @return the EmployeeUpdateEmployeeByIdRequest instance itself
   */
  public EmployeeUpdateEmployeeByIdRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeUpdateEmployeeByIdRequest employeeUpdateEmployeeByIdRequest = (EmployeeUpdateEmployeeByIdRequest) o;
    return Objects.equals(this.email, employeeUpdateEmployeeByIdRequest.email) &&
        Objects.equals(this.firstName, employeeUpdateEmployeeByIdRequest.firstName) &&
        Objects.equals(this.lastName, employeeUpdateEmployeeByIdRequest.lastName) &&
        Objects.equals(this.birthdayOn, employeeUpdateEmployeeByIdRequest.birthdayOn) &&
        Objects.equals(this.role, employeeUpdateEmployeeByIdRequest.role) &&
        Objects.equals(this.gender, employeeUpdateEmployeeByIdRequest.gender) &&
        Objects.equals(this.identifier, employeeUpdateEmployeeByIdRequest.identifier) &&
        Objects.equals(this.identifierType, employeeUpdateEmployeeByIdRequest.identifierType) &&
        Objects.equals(this.nationality, employeeUpdateEmployeeByIdRequest.nationality) &&
        Objects.equals(this.bankNumber, employeeUpdateEmployeeByIdRequest.bankNumber) &&
        Objects.equals(this.country, employeeUpdateEmployeeByIdRequest.country) &&
        Objects.equals(this.city, employeeUpdateEmployeeByIdRequest.city) &&
        Objects.equals(this.state, employeeUpdateEmployeeByIdRequest.state) &&
        Objects.equals(this.postalCode, employeeUpdateEmployeeByIdRequest.postalCode) &&
        Objects.equals(this.addressLine1, employeeUpdateEmployeeByIdRequest.addressLine1) &&
        Objects.equals(this.addressLine2, employeeUpdateEmployeeByIdRequest.addressLine2) &&
        Objects.equals(this.swiftBic, employeeUpdateEmployeeByIdRequest.swiftBic) &&
        Objects.equals(this.managerId, employeeUpdateEmployeeByIdRequest.managerId) &&
        Objects.equals(this.locationId, employeeUpdateEmployeeByIdRequest.locationId) &&
        Objects.equals(this.timeoffManagerId, employeeUpdateEmployeeByIdRequest.timeoffManagerId) &&
        Objects.equals(this.phoneNumber, employeeUpdateEmployeeByIdRequest.phoneNumber) &&
        Objects.equals(this.socialSecurityNumber, employeeUpdateEmployeeByIdRequest.socialSecurityNumber) &&
        Objects.equals(this.legalEntityId, employeeUpdateEmployeeByIdRequest.legalEntityId) &&
        Objects.equals(this.companyIdentifier, employeeUpdateEmployeeByIdRequest.companyIdentifier) &&
        Objects.equals(this.contactName, employeeUpdateEmployeeByIdRequest.contactName) &&
        Objects.equals(this.contactNumber, employeeUpdateEmployeeByIdRequest.contactNumber) &&
        Objects.equals(this.taxId, employeeUpdateEmployeeByIdRequest.taxId)&&
        Objects.equals(this.additionalProperties, employeeUpdateEmployeeByIdRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, birthdayOn, role, gender, identifier, identifierType, nationality, bankNumber, country, city, state, postalCode, addressLine1, addressLine2, swiftBic, managerId, locationId, timeoffManagerId, phoneNumber, socialSecurityNumber, legalEntityId, companyIdentifier, contactName, contactNumber, taxId, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeeUpdateEmployeeByIdRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeUpdateEmployeeByIdRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeUpdateEmployeeByIdRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeUpdateEmployeeByIdRequest is not found in the empty JSON string", EmployeeUpdateEmployeeByIdRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeUpdateEmployeeByIdRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeUpdateEmployeeByIdRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeUpdateEmployeeByIdRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeUpdateEmployeeByIdRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeUpdateEmployeeByIdRequest>() {
           @Override
           public void write(JsonWriter out, EmployeeUpdateEmployeeByIdRequest value) throws IOException {
           ...
           @Override
           public EmployeeUpdateEmployeeByIdRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeUpdateEmployeeByIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeUpdateEmployeeByIdRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeUpdateEmployeeByIdRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeeUpdateEmployeeByIdRequest
  */
  public static EmployeeUpdateEmployeeByIdRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeUpdateEmployeeByIdRequest.class);
  }

 /**
  * Convert an instance of EmployeeUpdateEmployeeByIdRequest to an JSON string
  *
  * @return JSON string
  */
