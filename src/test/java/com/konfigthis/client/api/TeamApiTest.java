...
import com.konfigthis.client.model.TeamCreateNewTeamRequest;
import com.konfigthis.client.model.TeamUpdateTeamByIdRequest;
...
public class TeamApiTest {
    ...
    public void getAllTeamsTest() throws ApiException {
        List<Team> response = api.getAllTeams()
                .execute();
        // TODO: test validations
    }
    ...
    public void getByIdTest() throws ApiException {
        String id = null;
        List<Team> response = api.getById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void removeTeamTest() throws ApiException {
        String id = null;
        Team response = api.removeTeam(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateTeamByIdTest() throws ApiException {
        String id = null;
        String description = null;
        String name = null;
        String avatar = null;
        Team response = api.updateTeamById(id)
                .description(description)
                .name(name)
                .avatar(avatar)
                .execute();
