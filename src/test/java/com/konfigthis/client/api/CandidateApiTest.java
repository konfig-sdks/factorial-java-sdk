...
public class CandidateApiTest {
    ...
    private static CandidateApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CandidateApi(apiClient);
    }
     ...
     */
    @Test
    public void createNewCandidateTest() throws ApiException {
        String firstName = null;
        String lastName = null;
        String email = null;
        String source = null;
        String medium = null;
        AtsCandidate response = api.createNewCandidate(firstName, lastName, email)
                .source(source)
                .medium(medium)
                .execute();
     ...
     */
    @Test
    public void deleteExistingCandidateTest() throws ApiException {
        String id = null;
        AtsCandidate response = api.deleteExistingCandidate(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listAllCandidatesTest() throws ApiException {
        List<AtsCandidate> response = api.listAllCandidates()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateCandidateDataTest() throws ApiException {
        String id = null;
        String firstName = null;
        String lastName = null;
        String email = null;
        Boolean talentPool = null;
        Boolean consentToTalentPool = null;
        AtsCandidate response = api.updateCandidateData(id)
                .firstName(firstName)
                .lastName(lastName)
                .email(email)
