...
import com.konfigthis.client.model.AtsMessage;
import com.konfigthis.client.model.MessageCreateAtsMessageRequest;
...
public class MessageApiTest {
     ...
     */
    @Test
    public void createAtsMessageTest() throws ApiException {
        Integer jobApplicationId = null;
        String content = null;
        AtsMessage response = api.createAtsMessage(jobApplicationId, content)
                .execute();
    ...
    public void getAllMessagesTest() throws ApiException {
        ...
        List<AtsMessage> response = api.getAllMessages(conversationId)
                .execute();
        // TODO: test validations
    }
