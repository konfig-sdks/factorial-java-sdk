...
public class ContractVersionCreateNewVersionRequest {
 ...
 public enum SalaryFrequencyEnum {
  ...
  public ContractVersionCreateNewVersionRequest() {
  }

  public ContractVersionCreateNewVersionRequest effectiveOn(String effectiveOn) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2022-04-22", value = "")
  ...
  public ContractVersionCreateNewVersionRequest employeeId(Integer employeeId) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest startsOn(String startsOn) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest endsOn(String endsOn) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest workingHoursFrequency(WorkingHoursFrequencyEnum workingHoursFrequency) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest workingWeekDays(String workingWeekDays) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest workingHours(Integer workingHours) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest salaryFrequency(SalaryFrequencyEnum salaryFrequency) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest salaryAmount(Integer salaryAmount) {
  ...
  **/
  ...
  public ContractVersionCreateNewVersionRequest jobTitle(String jobTitle) {
  ...
  **/
   ...
   * @return the ContractVersionCreateNewVersionRequest instance itself
   */
  public ContractVersionCreateNewVersionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContractVersionCreateNewVersionRequest contractVersionCreateNewVersionRequest = (ContractVersionCreateNewVersionRequest) o;
    return Objects.equals(this.effectiveOn, contractVersionCreateNewVersionRequest.effectiveOn) &&
        Objects.equals(this.employeeId, contractVersionCreateNewVersionRequest.employeeId) &&
        Objects.equals(this.startsOn, contractVersionCreateNewVersionRequest.startsOn) &&
        Objects.equals(this.endsOn, contractVersionCreateNewVersionRequest.endsOn) &&
        Objects.equals(this.workingHoursFrequency, contractVersionCreateNewVersionRequest.workingHoursFrequency) &&
        Objects.equals(this.workingWeekDays, contractVersionCreateNewVersionRequest.workingWeekDays) &&
        Objects.equals(this.workingHours, contractVersionCreateNewVersionRequest.workingHours) &&
        Objects.equals(this.salaryFrequency, contractVersionCreateNewVersionRequest.salaryFrequency) &&
        Objects.equals(this.salaryAmount, contractVersionCreateNewVersionRequest.salaryAmount) &&
        Objects.equals(this.jobTitle, contractVersionCreateNewVersionRequest.jobTitle)&&
        Objects.equals(this.additionalProperties, contractVersionCreateNewVersionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(effectiveOn, employeeId, startsOn, endsOn, workingHoursFrequency, workingWeekDays, workingHours, salaryFrequency, salaryAmount, jobTitle, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ContractVersionCreateNewVersionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ContractVersionCreateNewVersionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ContractVersionCreateNewVersionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContractVersionCreateNewVersionRequest is not found in the empty JSON string", ContractVersionCreateNewVersionRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContractVersionCreateNewVersionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContractVersionCreateNewVersionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContractVersionCreateNewVersionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContractVersionCreateNewVersionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ContractVersionCreateNewVersionRequest>() {
           @Override
           public void write(JsonWriter out, ContractVersionCreateNewVersionRequest value) throws IOException {
           ...
           @Override
           public ContractVersionCreateNewVersionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ContractVersionCreateNewVersionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ContractVersionCreateNewVersionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ContractVersionCreateNewVersionRequest
  * @throws IOException if the JSON string is invalid with respect to ContractVersionCreateNewVersionRequest
  */
  public static ContractVersionCreateNewVersionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContractVersionCreateNewVersionRequest.class);
  }

 /**
  * Convert an instance of ContractVersionCreateNewVersionRequest to an JSON string
  *
  * @return JSON string
  */
