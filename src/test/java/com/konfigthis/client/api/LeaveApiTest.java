...
public class LeaveApiTest {
    ...
    public void createNewLeaveTest() throws ApiException {
        String startOn = null;
        String finishOn = null;
        Integer employeeId = null;
        String description = null;
        Integer leaveTypeId = null;
        String halfDay = null;
        Leave response = api.createNewLeave(startOn, finishOn, employeeId)
     ...
     */
    @Test
    public void createNewLeave_0Test() throws ApiException {
        String startOn = null;
        String finishOn = null;
        Integer employeeId = null;
        String description = null;
        ...
        Integer hoursAmountInCents = null;
        Integer medicalLeaveType = null;
        String effectiveOn = null;
        String medicalDischargeReason = null;
        Integer colegiateNumber = null;
        Boolean hasPreviousRelapse = null;
        Integer relapseLeaveId = null;
        String relapseOn = null;
        String accidentOn = null;
        String paternityBirthOn = null;
        Leave response = api.createNewLeave_0(startOn, finishOn, employeeId)
                .description(description)
                .leaveTypeId(leaveTypeId)
                .halfDay(halfDay)
                .startTime(startTime)
    ...
    public void deleteByIdTest() throws ApiException {
        String id = null;
        Leave response = api.deleteById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteById_0Test() throws ApiException {
        String id = null;
        LeaveV2 response = api.deleteById_0(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getById_0Test() throws ApiException {
        String id = null;
        LeaveV2 response = api.getById_0(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getCompanyLeavesTest() throws ApiException {
        List<Integer> employeeIds = null;
        List<Integer> leaveTypeIds = null;
        String from = null;
        String to = null;
        Boolean includeLeaveType = null;
        List<Leave> response = api.getCompanyLeaves()
     ...
     */
    @Test
    public void getCompanyLeaves_0Test() throws ApiException {
        List<Integer> employeeIds = null;
        List<Integer> leaveTypeIds = null;
        String from = null;
        String to = null;
        Boolean includeLeaveType = null;
        List<LeaveV2> response = api.getCompanyLeaves_0()
                .employeeIds(employeeIds)
                .leaveTypeIds(leaveTypeIds)
                .from(from)
                .to(to)
    ...
    public void getTypesTest() throws ApiException {
        List<LeaveType> response = api.getTypes()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void typeCreateTest() throws ApiException {
        String name = null;
        String color = null;
        Boolean accrues = null;
        Boolean active = null;
        Boolean approvalRequired = null;
        Boolean attachment = null;
        Boolean visibility = null;
        Boolean workable = null;
        LeaveType response = api.typeCreate(name, color)
                .accrues(accrues)
                .active(active)
    ...
    public void updateByIdTest() throws ApiException {
        ...
        String startOn = null;
        String startTime = null;
        Integer hourAmountInCents = null;
        LeaveV2 response = api.updateById(id)
                .description(description)
     ...
     */
    @Test
    public void updateLeaveByIdTest() throws ApiException {
        String id = null;
        String description = null;
        Integer employeeId = null;
        Integer finishOn = null;
        String startOn = null;
        String halfDay = null;
        Integer leaveTypeId = null;
        Leave response = api.updateLeaveById(id)
                .description(description)
                .employeeId(employeeId)
                .finishOn(finishOn)
                .startOn(startOn)
    ...
    public void updateTypeTest() throws ApiException {
        ...
        Boolean visibility = null;
        Boolean workable = null;
        LeaveType response = api.updateType(name, color, id)
                .accrues(accrues)
                .active(active)
                .approvalRequired(approvalRequired)
                .attachment(attachment)
