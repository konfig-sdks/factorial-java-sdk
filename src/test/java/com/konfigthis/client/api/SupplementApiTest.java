...
public class SupplementApiTest {
    ...
    private static SupplementApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SupplementApi(apiClient);
    }
     ...
     */
    @Test
    public void createNewSupplementTest() throws ApiException {
        Integer employeeId = null;
        Integer amountInCents = null;
        String effectiveOn = null;
        Integer contractsTaxonomyId = null;
        Integer payrollPolicyPeriodId = null;
        String unit = null;
        Integer contractsCompensationId = null;
        Supplement response = api.createNewSupplement()
    ...
    public void deleteByIdTest() throws ApiException {
        String id = null;
        Supplement response = api.deleteById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getAllTest() throws ApiException {
        List<Supplement> response = api.getAll()
                .execute();
        // TODO: test validations
    }
    ...
    public void updateByIdTest() throws ApiException {
        ...
        String unit = null;
        Integer contractsCompensationId = null;
        Supplement response = api.updateById(id)
                .employeeId(employeeId)
                .amountInCents(amountInCents)
                .effectiveOn(effectiveOn)
                .contractsTaxonomyId(contractsTaxonomyId)
