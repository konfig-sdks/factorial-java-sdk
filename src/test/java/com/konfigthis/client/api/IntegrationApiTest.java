...
public class IntegrationApiTest {
     ...
     */
    @Test
    public void deletePayrollCodeTest() throws ApiException {
        String id = null;
        Code response = api.deletePayrollCode(id)
                .execute();
     ...
     */
    @Test
    public void getAllCodesTest() throws ApiException {
        String integration = null;
        String code = null;
        List<Code> response = api.getAllCodes()
     ...
     */
    @Test
    public void updatePayrollCodeTest() throws ApiException {
        String id = null;
        Integer id = null;
        String code = null;
        Code response = api.updatePayrollCode(id)
                .id(id)
                .code(code)
                .execute();
        // TODO: test validations
