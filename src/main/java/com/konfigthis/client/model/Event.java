...
public class Event {
  ...
  **/
  ...
  @ApiModelProperty(example = "dfc5126-1a65-4cfa-b8ef-3988e22d89b3", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Timeoff::Events::TimeoffPolicyCreated", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Time-off policy created", value = "")
  ...
  public Event datetime(String datetime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-09-20T10:56:06.620Z", value = "")
  ...
  public Event resourceId(Integer resourceId) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, name, datetime, resourceId, additionalProperties);
  }
