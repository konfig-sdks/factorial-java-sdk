...
public class DocumentApiTest {
    ...
    public void createNewDocumentTest() throws ApiException {
        ...
        Boolean requestEsignature = null;
        Boolean _public = null;
        List<Integer> signees = null;
        Boolean isPendingAssignment = null;
        Document response = api.createNewDocument(filename, _file)
    ...
    public void deleteByIdTest() throws ApiException {
        String id = null;
        Document response = api.deleteById(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getByIdTest() throws ApiException {
        String id = null;
        Document response = api.getById(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listGivenEmployeeOrFolderTest() throws ApiException {
        Integer employeeId = null;
        Integer folderId = null;
        List<Document> response = api.listGivenEmployeeOrFolder()
                .employeeId(employeeId)
                .folderId(folderId)
                .execute();
        // TODO: test validations
    ...
    public void updateByIdTest() throws ApiException {
        ...
        Boolean requestEsignature = null;
        List<Integer> signees = null;
        Document response = api.updateById(id)
                ._public(_public)
                .employeeId(employeeId)
                .folderId(folderId)
                .requestEsignature(requestEsignature)
