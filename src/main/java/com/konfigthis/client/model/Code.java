...
public class Code {
  ...
  **/
  ...
  public Code codeableId(Integer codeableId) {
  ...
  **/
  ...
  public Code integration(String integration) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "a3nom", value = "")
  ...
  public Code codeableType(String codeableType) {
  ...
  **/
  ...
  public String getCodeableType() {
    return codeableType;
  }


  public void setCodeableType(String codeableType) {
  ...
  **/
  ...
  public Code companyId(Integer companyId) {
  ...
  **/
  ...
  public Code forfaitJours(Boolean forfaitJours) {
  ...
  **/
   ...
   * @return the Code instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, code.id) &&
        Objects.equals(this.codeableId, code.codeableId) &&
        Objects.equals(this.integration, code.integration) &&
        Objects.equals(this.codeableType, code.codeableType) &&
        Objects.equals(this.code, code.code) &&
        Objects.equals(this.companyId, code.companyId) &&
        Objects.equals(this.forfaitJours, code.forfaitJours)&&
        Objects.equals(this.additionalProperties, code.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, codeableId, integration, codeableType, code, companyId, forfaitJours, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Code.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if ((jsonObj.get("codeable_type") != null && !jsonObj.get("codeable_type").isJsonNull()) && !jsonObj.get("codeable_type").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Code>() {
           ...
           public Code read(JsonReader in) throws IOException {
             ...
             Code instance = thisAdapter.fromJsonTree(jsonObj);
