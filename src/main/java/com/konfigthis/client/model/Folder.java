...
public class Folder {
  ...
  **/
  ...
  public Folder companyId(Integer companyId) {
  ...
  **/
  ...
  public Folder active(Boolean active) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, folder.id) &&
        Objects.equals(this.companyId, folder.companyId) &&
        Objects.equals(this.name, folder.name) &&
        Objects.equals(this.active, folder.active) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, name, active, createdAt, updatedAt, additionalProperties);
  }
